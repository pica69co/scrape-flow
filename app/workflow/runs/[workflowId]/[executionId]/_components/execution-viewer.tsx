...
export const ExecutionViewer = ({
  ...
  useEffect(() => {
    ...
    // if completed, select the last phase
    const phaseToSelect = phases.toSorted((a, b) =>
    ...
    <Card className="w-full">
      ...
      <CardContent className="p-0">
        <Table>
          ...
          <TableBody>
            {logs.map((log) => (
              <TableRow key={log.id} className="text-sm text-muted-foreground">
                <TableCell
                  width={190}
                ...
                <TableCell
                  ...
                  className={cn(
                    ...
                    (log.logLevel as LogLevel) === "error" && "text-red-500",
                    (log.logLevel as LogLevel) === "info" && "text-emerald-500"
                  )}
                >
                  {log.logLevel}
                </TableCell>
